...
public class BcServiceActivity extends BaseServiceActivity implements MyAllBookView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //假 普通
        //spUtils.put("openId", "tXhi94jQkXPovBsqEs0B8QKsbM0A");
    ...
    private BcServiceActivity.MyHandler mHandler = new BcServiceActivity.MyHandler();
            ...
            switch (msg.what) {
                ...
                case 1://检查签到成功
                    ...
                    if (checkInBean.isTodayCheckedIn()) {
                        showCheckInWindow(BcServiceActivity.this, checkInBean);
                    }/* else {
