...
public class MyCompetitiveFragment extends Fragment implements MyCompetitiveBookView {
    @Bind(R.id.recycle)
    ...
    public void RefreshBookCaseBeanEventBus(RefreshBookCaseBean refreshBookCaseBean) {
        ...
        if (refreshBookCaseBean.isRefreshCompetitive()) {
            refresh.autoRefresh();
            refreshBookCaseBean.setRefreshCompetitive(false);
