...
public class CollageServiceActivity extends BaseServiceActivity {
    ...
    private void init() {
        ...
        viewPagerCollage.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                switch (position) {
                    case 0:
                        linearParams.height = DensityUtil.dip2px(CollageServiceActivity.this, 810);// 当控件的高强制设成50象素
                        break;
                    case 1:
                        linearParams.height = DensityUtil.dip2px(CollageServiceActivity.this, 650);// 当控件的高强制设成50象素
                        break;
                }
