...
public class ExpertBookDetailServiceActivity extends BaseServiceActivity {
            ...
            case R.id.et_comment:
                etComment.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(ExpertBookDetailServiceActivity.this, CommentServiceActivity.class);
