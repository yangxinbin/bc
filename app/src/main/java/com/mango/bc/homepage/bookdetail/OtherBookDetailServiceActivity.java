...
public class OtherBookDetailServiceActivity extends BaseServiceActivity implements MyAllBookView {
    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.l_share_get:
                ...
                break;
            case R.id.l_txt_get:
                intent = new Intent(this, TxtServiceActivity.class);
            ...
            case R.id.book_stage_needbuy_money:
                intent = new Intent(this, BuyBookServiceActivity.class);
                ...
                HttpUtils.doPost(Urls.HOST_BUYBOOK, mapParams, new Callback() {
                    ...
                    public void onFailure(Call call, IOException e) {
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                AppUtils.showToast(OtherBookDetailServiceActivity.this, "领取失败");
                            }
                        });
                    }
                        ...
                        try {
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    lFree.setVisibility(View.GONE);//进去免费领取界面
                                    lNeedbuy.setVisibility(View.GONE);//进去购买领取界面
                                    if (NetUtil.isNetConnect(OtherBookDetailServiceActivity.this)) {
                                        myBookPresenter.visitBooks(OtherBookDetailServiceActivity.this, 3, 0, false);//获取书架的所有书(加入刷新)
                                    } else {
                                        myBookPresenter.visitBooks(OtherBookDetailServiceActivity.this, 3, 0, true);//获取书架的所有书(加入刷新)
