...
public class SearchBookDetailActivity extends BaseActivity {
    ...
    @Bind(R.id.l_like_buyexpert)
    PraiseView lLikeBuyexpert;
    @Bind(R.id.l_try_buyexpert)
    LinearLayout lTryBuyexpert;
    @Bind(R.id.l_buy_buyexpert)
    TextView lBuyBuyexpert;
    @Bind(R.id.l_collage_buyexpert)
    ...
    @Override
    protected void onCreate(Bundle savedInstanceState) {   //大咖+精品+上新+免费 详情共用  判断：是否领取   是否购买  三种 精品上新一样
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.book_stage_needbuy_money:
                break;
            case R.id.l_needbuy:
                break;//以上需要购买或者加入vip才能播放  精品+上新
            case R.id.l_like_buyexpert:
                break;
            case R.id.l_try_buyexpert:
                break;
            case R.id.l_buy_buyexpert:
                break;
            case R.id.l_collage_buyexpert:
                break;//以上大咖课 需要购买
        }
    }
