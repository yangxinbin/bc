...
public class CollageAllFragment extends Fragment implements CollageAllView {
    @Bind(R.id.recycle)
    ...
    private final int STAYUA = 0;//所有
    private int page = 0;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.collage_all, container, false);
    ...
    @Override
    public void addSuccessCollageAll(String s) {
