...
public class CollageFailFragment extends Fragment implements CollageFailView {
    @Bind(R.id.recycle)
    ...
    @Override
    public void addCollageFail(final List<CollageBean> collageBeans) {
        if (getActivity() != null)
    ...
    @Override
    public void addSuccessCollageFail(String s) {

    }

    @Override
    public void addFailCollageFail(String f) {
        if (getActivity() != null)
            getActivity().runOnUiThread(new Runnable() {
                @Override
                public void run() {
