...
public class CollageIngFragment extends Fragment implements CollageIngView {
    @Bind(R.id.recycle)
    ...
    private final int STAYUA = 1;//正在
    private int page = 0;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.collage_ing, container, false);
    ...
    @Override
    public void addSuccessCollageIng(String s) {
