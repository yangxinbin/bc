...
public class LikeServiceActivity extends BaseServiceActivity implements AdapterView.OnItemClickListener {
    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.button_next:
                intent = new Intent(this, UserDetailServiceActivity.class);
                startActivity(intent);
                finish();
                break;
        }
