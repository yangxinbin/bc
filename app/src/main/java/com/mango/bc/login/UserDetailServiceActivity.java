...
import com.mango.bc.BcServiceActivity;
...
public class UserDetailServiceActivity extends BaseServiceActivity implements AdapterView.OnItemClickListener {
    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            case R.id.imageView_back:
                ...
                break;
            case R.id.tv_jump:
                intent = new Intent(this, BcServiceActivity.class);
                startActivity(intent);
                finish();
                break;
