...
import com.mango.bc.wallet.activity.ProblemServiceActivity;

import butterknife.Bind;
import butterknife.ButterKnife;
import butterknife.OnClick;

public class FaqServiceActivity extends BaseServiceActivity {
    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            case R.id.imageView_back:
                ...
                break;
            case R.id.l_1:
                intent = new Intent(this, ProblemServiceActivity.class);
