...
public class VipAutoServiceActivity extends BaseServiceActivity {
                ...
                HttpUtils.doPut(Urls.HOST_AUTOBILL, mapParams, new Callback() {
                    ...
                    public void onFailure(Call call, IOException e) {
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                AppUtils.showToast(VipAutoServiceActivity.this, "取消失败");
                            }
                        });
                    }
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        try {
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    AppUtils.showToast(VipAutoServiceActivity.this, "取消成功");
                                    loadUser();
                                }
                            });
                        } catch (Exception e) {
